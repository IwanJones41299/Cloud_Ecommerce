            ...
            <Message variant='danger'>{error}</Message> : (
                ...
                <Col md={3}>
                    ...
                    <ListGroup.Item>
                        ...
                        {product.stock > 0 && (
                            <ListGroup.Item>
                                <Row>
                                    <Col>Qty</Col>
                                    <Col>
                                    <Form.Control style={{padding: '.25rem .25rem'}} as='select' value={qty} onChange={(e) => setQty(e.target.value)}>
                        ...
                        <ListGroup.Item>
                            <Button onClick={adddToCartHandler} className="btn-block" type="button" disabled={product.stock === 0}>Add to Cart</Button>
                        </ListGroup.Item>
                    </Card>
                </Col>
            </Row>
